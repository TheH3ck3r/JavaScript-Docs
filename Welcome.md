...
[!badge variant="contrast" text="Array"](Структуры_данных/Array.md) - Это структура данных в JavaScript, представляющая собой упорядоченную коллекцию значений, которые могут быть любых типов.

[!badge variant="contrast" text="Map"](Структуры_данных/Map.md) - Это структура данных в JavaScript, представляющая собой коллекцию пар ключ-значение, в которой ключи могут быть любого типа (включая объекты, функции и примитивы).
